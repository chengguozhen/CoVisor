...
plot in u 3:2:4:xtic(1) t col lt 1 lc rgb 'blue' fs pattern 2

set output 'Eval_gateway_rule.pdf'
set yrange [100:100000]
set ylabel '# of Flowmods' offset 2
plot in u 6:5:7:xtic(1) t col lt 1 lc rgb 'blue' fs pattern 2

set output 'Eval_gateway_total.pdf'
set yrange [0.1:1000]
set ylabel 'Time (second)' offset 2
plot in u 12:11:13:xtic(1) t col lt 1 lc rgb 'blue' fs pattern 2
